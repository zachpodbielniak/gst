...
:PROPERTIES:
:CUSTOM_ID: unix-socket-recommended
:END:
...
*** Screen Reading
:PROPERTIES:
:CUSTOM_ID: screen-reading
:END:
**** =read_screen=
:PROPERTIES:
:CUSTOM_ID: read_screen
:END:
...
*** Process Awareness
:PROPERTIES:
:CUSTOM_ID: process-awareness
:END:
**** =get_foreground_process=
:PROPERTIES:
:CUSTOM_ID: get_foreground_process
:END:
...
:PROPERTIES:
:CUSTOM_ID: get_working_directory
:END:
...
*** URL Detection
:PROPERTIES:
:CUSTOM_ID: url-detection
:END:
**** =list_detected_urls=
:PROPERTIES:
:CUSTOM_ID: list_detected_urls
:END:
...
:PROPERTIES:
:CUSTOM_ID: configuration-management
:END:
**** =get_config=
:PROPERTIES:
:CUSTOM_ID: get_config
:END:
...
:PROPERTIES:
:CUSTOM_ID: cross-module-dependencies
:END:
